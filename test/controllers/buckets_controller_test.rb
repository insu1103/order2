...
class BucketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bucket" do
    assert_difference('Bucket.count') do
      post buckets_url, params: { bucket: { integer: @bucket.integer, total: @bucket.total } }
    end
  ...
  test "should update bucket" do
    patch bucket_url(@bucket), params: { bucket: { integer: @bucket.integer, total: @bucket.total } }
